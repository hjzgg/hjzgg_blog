...
<div class="wrap" style="height: 500px;">
	...
	<span style="font-weight: 800; font-size: 20px; color: red; z-index:10;">&nbsp;&nbsp;&nbsp;&nbsp;${session.errors}</span>
	<div class="banner" style="position: absolute; left:0px; top:0px; width:100%; height:500px; filter:alpha(opacity=70); -moz-opacity:0.70; opacity:0.70;">
		<img height="400" width="300" src="./image/messageImages/errors.png" alt="操作提示" title="操作提示"/>
		<div class="page">
