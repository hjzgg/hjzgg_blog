		    ...
		    <div class="col-xs-12 col-sm-6 col-md-8">
		    	<div class="panel panel-default blog-panel">
				  	<div class="blog-panel-heading">
				  	 	<h3 class="panel-title"><span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span>&nbsp;&nbsp;博客分组: &nbsp;${session.groupJspGetOneGroup.groupName}</h3>
				 	</div>
				 	<div class="panel-body">
				 		<div class="panel panel-success">
							  <div class="panel-body">
							     	分组描述：${session.groupJspGetOneGroup.groupDescrib}
							  </div>
						 </div>
				    	<%
					    	int pageCur=0, pageBegin=0, pageTot=0, num= 0;
						    final int pageSize = 1;//每一面显示的文章的数目
						    BlogGroup blogGroup = (BlogGroup)session.getAttribute("groupJspGetOneGroup");
							List<BlogArticle> articleList = new ArrayList<BlogArticle>();
							articleList.addAll(blogGroup.getArticle());//加入分组的文章
					    ...
					    %>
					    			  <div class="panel panel-success">
										  ...
										  <div class="panel-body">
										     	...
										     	<div class="blog-postDesc">posted @ ${article.articleBuildTime} 胡峻峥 阅读(${article.articleReadingCount}) 评论(${fn:length(article.comments)})  <a href="blogAction!updateEditJpsGetOneArticle?articleId=${article.articleId}" rel="nofollow">编辑</a></div>
										  </div>
									  </div>
						<%
						   		 }
...
<script type="text/javascript">
	var blogGroupId = ${session.groupJspGetOneGroup.groupId};
	function myGoTo(pageIndex){
		location.href = "blogAction!groupJspGetOneGroup?" + pageIndex + "&blogGroupId=" + blogGroupId;
	}
