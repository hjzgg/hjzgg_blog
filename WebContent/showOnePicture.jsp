		...
		<div class="row">
		  <div class="col-xs-12 col-md-12">
				  ...
				  <div class="blog-panel-heading">
				  	相册分组: <%=request.getParameter("showOnePictureJsp_groupName")%>
				  </div>
				  <!-- List group -->
				  <div class="panel-body">
		  				<div style="width:100%; text-align: center;">
							 <img style="max-width:100%;" src="<%=request.getParameter("showOnePictureJsp_picturePath")%>" alt="<%=request.getParameter("showOnePictureJsp_pictureName")%>" title="<%=request.getParameter("showOnePictureJsp_pictureName")%>" alt="<%=request.getParameter("showOnePictureJsp_pictureName")%>">
			  			</div>
				  </div>
				</div>
		  </div>
