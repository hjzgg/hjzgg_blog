	...
	<div class="container">
		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      <ul class="nav navbar-nav blog_nav">
		        ...
		        <li class="active"><a href="blogAction!editJspGetAllGroups">新随笔</a></li>
		...
		<div class="row">
		  <div class="col-xs-12 col-md-12">
			<div class="panel panel-default blog-panel">
				  <!-- Default panel contents -->
				  <div class="blog-panel-heading">添加新随笔</div>
				  <!-- List group -->
				  <form action="blogAction!newBlogArticle" method="post" name="articleForm" id="newArticleForm">
					  <ul class="list-group">
					    <li class="list-group-item">
							<div class="input-group">
							  <span class="input-group-addon" id="basic-addon1">博客标题:</span>
							  <input type="text" class="form-control" placeholder="blog-title" name="blogArticleForm.articleTitle" aria-describedby="basic-addon1">
							</div>
						</li>
