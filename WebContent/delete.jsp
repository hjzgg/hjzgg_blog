	...
	<div class="container">
		...
		<div class="row">
		  <div class="col-xs-12 col-md-12">
				  ...
				  <div class="blog-panel-heading">随笔删除</div>
					  ...
					  <table class="table table-hover">
					      ...
					      <tbody>
					      	<%
								...
								List<BlogArticle> articleList = (List<BlogArticle>)session.getAttribute("deleteJpsGetAllArticles");
						    ...
						    %>
						        <tr>
						          ...
						          <td id="operationId<%=i+1%>"><a class="btn btn-info" href="javascript:void(0)" onclick="myDeleteArticle('operationId<%=i+1%>', '${article.articleId}')" role="button">删除</a></td>
						        </tr>
						    <%
								}
							%>
...
<script type="text/javascript">
	function myGoTo(pageIndex){
		location.href = "blogAction!deleteJpsGetAllArticles?" + pageIndex;
	}
	...
	function myDeleteArticle(operationId, articleId){
		$.ajax({
		    type:"post",
		    url: "blogAction!deleteBlogArticle",
